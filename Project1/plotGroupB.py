...
with open('Project1_data/groupB.csv', 'rb') as csvfile:
...
for el in data:
	if int(el[2]) == 0: # if it's a male data point
		...
		distance = ( ((float(el[1]) - 160) * (6.25 - 5.45)) - ((float(el[0]) - 5.45) * (130 - 160)) )
...
plt.plot([5.45, 6.25], [160, 130], color='g', linewidth=2.0);
